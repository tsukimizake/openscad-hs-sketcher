...
main = hspec $ describe "SketchExamples" $ do
  ...
  it "pitagoras1" do
    let pitagoras1 = sketchRecord do
          a <- point & x 0 & y 0
          b <- point & x 4 & y 0
  ...
  it "pitagoras2" do
    let pitagoras2 = sketchRecord do
          a <- point & x 0 & y 0
  ...
  it "pitagoras3" do
    let pitagoras3 = sketchRecord do
  ...
  it "chamferPita" do
    let chamferPita = sketchRecord do
          a <- point & x 0 & y 0
          b <- point & x 4 & y 0
          v1 <- line & from a & degree 30
          v2 <- line & from b & degree 90
